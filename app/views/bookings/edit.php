			...
			<div class="panel-body">
				<form class="form-horizontal" method="POST" action="<?php echo url();?>/bookings">
					...
					<div class="form-group">
						 ...
						 <div class="col-sm-3">
							 <input type="text" id="checkin_time" value="<?php echo $data->checkin_time;?>"  name="checkin_time" class="form-control" required/>
						 </div>
					</div>
					<div class="form-group">
						 <label class="col-sm-2 control-label">Number Of Time</label>
						 <div class="col-sm-3">
							 <input type="number" value="<?php echo $data->number_of_time;?>" id="number_of_time"  name="number_of_time" class="form-control" />
						 </div>
					</div>
					<div class="form-group">
						 <label class="col-sm-2 control-label">Checkout Time</label>
						 <div class="col-sm-3">
							 <input type="text" id="checkout_time" value="<?php echo $data->checkout_time;?>" name="checkout_time" class="form-control"/>
						 </div>
					</div>
					<div class="form-group">
