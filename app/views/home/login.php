...
<html dir="ltr" lang="en">
	...
	<body>
		<div id="container">
				...
				<div class="container-fluid">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						<div class="panel-body">
							<div class="row">
								<center>
									<a href="<?php echo url();?>/regist" data-toggle="tooltip" title="Back To Grid" class="btn btn-default"><i class=" fa fa-user-circle-o"></i> Sign Up Now</a>
								</center>
							</div>
						</div>
					</div>
			...
			<footer id="footer">
				<a href="#">My Spacible</a> &copy; <?php echo date('Y');?> All Rights Reserved.
				<br />
			</footer>
		</div>
	</body>
