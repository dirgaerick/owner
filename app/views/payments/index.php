					...
					<table class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<?php 
										$cek = CekPayments($row->id);
										if($cek){
											echo "<small class='label label-success'>Payed</small>";
										}else{
											echo "<small class='label label-danger'>Not Payed</small>";
										}
									?>
								</td>
								<td>
									<a href="<?php echo url();?>/payments/show/<?php echo $row->id;?>"><i class="fa fa-pencil"></i></a>
								</td>
							</tr>
							<?php $no++; EndForeach; ?>
						</tbody>
