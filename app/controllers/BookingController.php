...
class BookingController extends Controller{
	...
	public function getSave(){
		...
		if($id){
			...
			$bookings->checkin_time = Input::get('checkin_time');
			$bookings->number_of_time = Input::get('number_of_time');
			$bookings->date_booking = Input::get('date_booking');
			$bookings->date_booking_from = Input::get('date_booking');
			$bookings->checkout_time = Input::get('checkout_time');
			$bookings->save();
			...
			$TOTAL = $TOTAL*$bookings->number_of_time;
			$discount = $TOTAL*$disc;
	...
	public function getDelete($id){
		...
		$users = DB::table('booking_rooms')->where('booking_id', $id)->get();
	
	
	
	foreach ($users as $user) {
		$room_id =  $user->room_id;
		$d_room = Room::find($room_id);
